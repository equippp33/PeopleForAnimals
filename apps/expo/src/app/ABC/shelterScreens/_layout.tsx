...
export default function ShelterLayout() {
  ...
  const calendarRoutes = ['/surgicalScreens', '/surgicalScreens/schedule'];
  const hideBottomNavRoutes = ['/surgicalScreens/dogprofile', '/surgicalScreens/profile'];

  const showCalendar = calendarRoutes.includes(pathname);
